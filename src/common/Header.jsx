              ...
              <div className={`${!show ? "min-h-screen" : ""} `}>
                  <div className="flex justify-between items-center bg-transparent py-1.5">
                      ...
                      <div className={`flex flex-col lg:flex-row items-center gap-7 lg:gap-6 max-lg:fixed max-lg:justify-center duration-300 ease-linear top-0 max-lg:-right-full max-lg:backdrop-blur-md max-lg:z-[90] max-lg:h-screen max-lg:w-full ${show ? "" : " !right-0"
                          ...
                          <button className='sm:p-[13px_32px] p-[12px_24px] lg:hidden border lg:text-light-blue text-white lg:border-light-blue border-white rounded-lg font-medium text-base leading-4 lg:hover:text-white hover:text-light-blue hover:bg-light-blue duration-300'>
                              <span className="relative z-10">Enter App</span>
                          </button>
                      </div>
                      <button className='sm:p-[13px_32px] p-[12px_24px] hidden lg:block border lg:text-light-blue text-white lg:border-light-blue border-white rounded-lg font-medium text-base leading-4 lg:hover:text-white hover:text-light-blue hover:bg-light-blue duration-300'>
                          <span className="relative z-10">Enter App</span>
                      </button>
                      <button
